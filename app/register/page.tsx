...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gray-50 dark:bg-black">
      {/* Background orbs */}
      <div className="absolute top-20 right-1/4 w-72 h-72 bg-violet-200 dark:bg-violet-500/10 rounded-full blur-3xl opacity-30 dark:opacity-15" />
      <div className="absolute bottom-20 left-1/4 w-64 h-64 bg-cyan-200 dark:bg-cyan-500/10 rounded-full blur-3xl opacity-30 dark:opacity-15" />
        ...
        <div className="rounded-2xl border border-gray-200/80 dark:border-gray-800/80 bg-white/90 dark:bg-black/80 backdrop-blur-xl p-8 shadow-xl shadow-black/5">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Start generating sales pages instantly
            </p>
          </div>

          {/* Benefits */}
          <div className="flex flex-wrap justify-center gap-3 mb-6 text-xs">
            {["Free to start", "No credit card", "Export HTML"].map((item) => (
              <span
                key={item}
                className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400"
              >
